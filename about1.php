...
<body class="host_version">
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>About U<span class="m_1"> The Ghana-India Kofi Annan Centre of Excellence in ICT is Ghana's First Advanced Information Technology Institute </span></h1>
		</div>
	</div>
        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <h3>About</h3>
                    <p> The Ghana-India Kofi Annan Centre of Excellence in ICT is Ghana's First Advanced Information Technology Institute </p>
                </div>
            </div><!-- end title -->
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4>2019 BEST SmartEDU education school</h4>
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-center">
                    <p class="footer-company-name">All Rights Reserved. &copy; 2019 <a href="#">SmartEDU</a> Design By : <a href="https://php.design/">php design</a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
