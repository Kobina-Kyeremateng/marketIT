  ...
  <div class="table-responsive">
    ...
    <div class="container" style="width:100%">
      <ul class="nav nav-tabs">
        ...
        <li  class="active"><a href="?page=adminEdit">Edit Staff <img src="assets/img/import.png"></a></li>
              ...
              <div class="panel panel-primary">
                  <div class="panel-heading">Edit a Staff</div>
                           <!-- <div class="table">
                            ...
                            <form action="addstaffAction.php" method="post"  enctype="multipart/form-data">
                              <div style="float:left;  position:relative">
                                ...
                                <div style="float:right; position:relative">
                                  <h4>Contact Details</h4>
                                    ...
                                    <div class="fieldgroup">
                                      <input type="datetime" name="appointmentDate" id="appointmentDate" value="<?php echo $appointmentDate?>">
