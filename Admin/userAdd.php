...
<div>
  ...
  <div class="table-responsive">
    ...
    <div class="container" style="width:100%">
      <ul class="nav nav-tabs">
        <li class="active"><a href="?page=userAdd">New Client <img src="assets/img/new.png"> </a></li>
                  ...
                  <div class="table">
                    ...
                    <form action="userAction.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div style="float:right; position:relative">
                        ...
                        <div>
                          <label>Service</label>
                            <select name="service" id="service" class="form-control">
                              ...
                              $result = mysqli_query($con, $querry);
                              while ($data = mysqli_fetch_assoc($result)) {
                                echo "<option value=" . $data['ServiceID'] . ">" . $data['ServiceName'] . "</option>";
                              }
                              ?>
                            </select>
                        </div>
                        ...
                        <div>
                          <input type="hidden" name="role" id="role" value="2" readonly>
                        </div>
                      </div>
                      ...
                      <div style="float:left;  position:relative; clear:both;">
                        ...
                        <div><button onclick="checkDOB()" onclick="sayHurray()" class="ladda-button seven btn btn-warning" data-style="zoom-out" name="saveUser">Submit</button></div>
                    </form>
                  </div>
                </div>
              </div>
