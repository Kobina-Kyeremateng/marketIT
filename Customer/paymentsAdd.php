...
<div>
  <ul class="nav nav-tabs">
      ...
      <!-- <li class="active"><a href="?page=viewClassAc">Accountant<img src="assets/img/update.png"></a></li> -->
        ...
        <div class="panel panel-primary">
          <div class="panel-heading">Add a Payment</div>
            <div class="table"></div>
              ...
              <form action="addPaymentsAction.php" method="post">
                  <div style="float:left;  position:relative">
                            <div>
                              <label>Student ID</label>
                                <?php
                                    ...
                                    $querry="select * from student where studentID='$id'";
                                    $result=mysqli_query($con,$querry);
                                    $data=mysqli_fetch_assoc($result);
                                ?>
                                <input type="text" name="studentID" id="studentID"  value="<?=$data['studentID']?>" readonly>
                            </div>
                            ...
                            <div>
                              <label>Fee Payable</label>
                                ...
                                $cid=$_GET['id'];
                                $con=mysqli_connect('localhost','root','','marketit');
                                $querry="select * from course1 where course_id='$cid'";
                                $result=mysqli_query($con,$querry);
                                $data=mysqli_fetch_assoc($result);
                                ?>
