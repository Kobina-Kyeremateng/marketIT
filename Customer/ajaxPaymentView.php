                    ...
                    <!-- <div class="ibox bg-boxshadow mb-30"> -->
                        ...
                        <!-- <div class="ibox-content"> -->
                            ...
                            <div class="table-responsive" id="search">
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                  ...
                                  <tbody>
                                    ...
                                    $query = "select users.Image, users.userID, users.FirstName, users.LastName, payments.paymentDate, payments.TotalArears, payments.AmountPaid,payments.Balance from payments inner join users on payments.userID = users.userID WHERE Users.RoleID='2'";
                            ...
                            echo "<tr class='gradeX'>
                                        ...
                                        <td class='center'>$TotalArears </td>
