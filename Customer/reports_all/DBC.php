...
$sql = "SELECT  studentID AS ADM_NO ,Firstname,Lastname,dateofbirth,gender,PhoneNumber,reg_date AS Admission_Date FROM student WHERE course='DBC'";
$resultset = mysqli_query($db, $sql) or die("database error:". mysqli_error($db));


$sql2 = "SELECT COUNT(gender) AS nu FROM student WHERE course='DBC' AND gender='Male'";
...
$sql3 = "SELECT COUNT(gender) AS nu FROM student WHERE course='DBC' AND gender='Female' ";
...
$pdf->SetXY(100,25);
$pdf->Cell(100,5,'Diploma in Business Computing',0,0,'C',0);
//C MEANS CENTERED
