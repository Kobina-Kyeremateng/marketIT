...
$sql = "SELECT  studentID AS ADM_NO ,Firstname,Lastname,dateofbirth,gender,PhoneNumber,reg_date AS Admission_Date FROM student WHERE course='NIS'";
$resultset = mysqli_query($db, $sql) or die("database error:". mysqli_error($db));


$sql2 = "SELECT COUNT(gender) AS nu FROM student WHERE course='NIS' AND gender='Male'";
...
$sql3 = "SELECT COUNT(gender) AS nu FROM student WHERE course='NIS' AND gender='Female' ";
...
$pdf->SetXY(100,25);
$pdf->Cell(100,5,'Network and Information Security',0,0,'C',0);
//C MEANS CENTERED
